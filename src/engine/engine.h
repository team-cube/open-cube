...
extern void copyhdr(int w, int h, GLenum target, GLuint tex);
extern void copyhdr(int sw, int sh, GLuint fbo, int dw, int dh, bool flipx = false, bool flipy = false, bool swapxy = false);
