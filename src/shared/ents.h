...
#define ANIM_REUSE       0x3FFFFF
#define ANIM_NOSKIN      (1<<22)
#define ANIM_SETTIME     (1<<23)
#define ANIM_FULLBRIGHT  (1<<24)
#define ANIM_NORENDER    (1<<25)
#define ANIM_RAGDOLL     (1<<26)
#define ANIM_SETSPEED    (1<<27)
#define ANIM_NOPITCH     (1<<28)
#define ANIM_FLAGS       0xFFC00000
